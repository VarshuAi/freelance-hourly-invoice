...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/freelance-hourly-invoice.git
   cd freelance-hourly-invoice
   ```
...
[![Repo](https://img.shields.io/badge/freelance-hourly-invoice-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/freelance-hourly-invoice)
